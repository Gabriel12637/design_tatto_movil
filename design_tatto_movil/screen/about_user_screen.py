    ...
    return rx.mobile_and_tablet(
        rx.container(
            ...
            rx.vstack(
                ...
                rx.button("Tatuaje pequeño", margin_bottom="40px", margin_left="50px", width="200px", color="black", background="transparent",
                          _hover={"background_color": "rgba(197, 109, 252, 1)"},
                          style={"border_left": "2px solid #c56dfc", "border_right": "2px solid #c56dfc"}
                          ),
                rx.button("Tatuaje mediano", margin_bottom="40px", margin_left="50px", width="200px", color="black", background="transparent",
                          _hover={"background_color": "rgba(197, 109, 252, 1)"},
                          style={"border_left": "2px solid #c56dfc", "border_right": "2px solid #c56dfc"}
                          ),
                rx.button("Tatuaje grande", margin_bottom="45px", margin_left="50px", width="200px", color="black", background="transparent",
                          _hover={"background_color": "rgba(197, 109, 252, 1)"},
                          style={"border_left": "2px solid #c56dfc", "border_right": "2px solid #c56dfc"}
                          ),
                rx.button("Estilo Tradicional", margin_bottom="40px", margin_left="50px", width="200px", color="black", background="transparent",
                          _hover={"background_color": "rgba(197, 109, 252, 1)"},
                          style={"border_left": "2px solid #c56dfc", "border_right": "2px solid #c56dfc"}
                          ),
